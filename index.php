...
?>
    ...
    <head>
        ...
        <link href="assets/images/rks.png" type="image/x-icon" rel="shortcut icon">
    ...
    <body class="hold-transition skin-green-light sidebar-mini">
        <div class="wrapper">
            ...
            <header class="main-header">
                <a href="./" class="rks">
                    <span class="rks-mini"><b></b></span>
                    <span class="rks-lg"><b></b> 
                </a>
                <!-- Header Navbar -->
  ...
  <strong>
    <i></i> <b><a style="color: #008cba">SPK Rekomendasi Penempatan Magang</a></b>
  </strong>
</footer>
